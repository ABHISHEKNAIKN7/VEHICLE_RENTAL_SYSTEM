...
def add_car():
    ...
    if request.method == 'POST':
        ...
        car_image_url = request.form.get('car_image_url', '').strip()
        file_handling.add_car(car_model, car_type, car_transmission, hourly_rate, car_image_url)
...
def modify_car():
    ...
    if request.method == 'POST':
        ...
        file_handling.update_car(car_id, new_model, new_car_type, new_transmission, new_rate, new_image_url)
